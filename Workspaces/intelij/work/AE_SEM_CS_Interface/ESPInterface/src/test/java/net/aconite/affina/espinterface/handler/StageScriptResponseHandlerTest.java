...
public class StageScriptResponseHandlerTest
{
    private static final Logger logger = LoggerFactory.getLogger(StageScriptResponseHandlerTest.class.getName());
    ...
    public void testMessage()
    {
        ...
        Message<String> msg = new GenericMessage<String>(TestData.STAGE_SCRIPT_RESPONSE_XML);
        inputChannel.send(msg);

        Message hsssc = outputChannel.receive();
        logger.info(hsssc.toString());

        //Message error = errorChannel.receive();
