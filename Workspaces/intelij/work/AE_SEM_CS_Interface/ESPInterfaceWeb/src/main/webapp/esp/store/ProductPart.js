var varProductPartMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});

Ext.define('App.store.ProductPart',
{
	extend		: 'Ext.data.Store',
	id			: 'idProductPartStore',
	model		: 'App.model.ProductPart',
	remoteSort	: true,
