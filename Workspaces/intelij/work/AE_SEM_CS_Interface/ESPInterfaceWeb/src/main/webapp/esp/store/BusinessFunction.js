var varBusinessFunctionMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});

Ext.define('App.store.BusinessFunction',
{
	extend		: 'Ext.data.Store',
	id			: 'idBusinessFunctionStore',
	model		: 'App.model.BusinessFunction',
	remoteSort	: true,
